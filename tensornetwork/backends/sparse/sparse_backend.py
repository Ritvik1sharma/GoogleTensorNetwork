...
class SparseBackend(abstract_backend.AbstractBackend):
  ...
  def __init__(self) -> None:
    ...
    try:
      ...
      raise ImportError("sparse not installed") from err
    sparselib = sparse
    self.name = "sparse"
  ...
  def tensordot(self, a: Tensor, b: Tensor,
    ...
    print("tensor dot ", a, b, " Axis: ", axes)
    # print("details, ", a.coords, a.data)
    # print("details, ", b.coords, b.data)
    return sparselib.tensordot(a, b, axes=axes)

  def reshape(self, tensor: Tensor, shape: Tensor) -> Tensor:
    return sparselib.reshape(tensor, np.asarray(shape).astype(np.int32))
  ...
  def shape_concat(self, values: Tensor, axis: int) -> Tensor:
    return sparselib.concatenate(values, axis)
  ...
  def sqrt(self, tensor: Tensor) -> Tensor:
    dense_array = tensor.todense()
    dense_sqrt = np.sqrt(dense_array)
    return sparselib.COO.from_numpy(dense_sqrt)    
    # return sparselib.sqrt(tensor)

  def convert_to_tensor(self, tensor: Tensor) -> Tensor:
    if (isinstance(tensor, np.ndarray) or np.isscalar(tensor)):
      # raise TypeError("Expected a `np.array` or scalar. Got {}".format(
      #     type(tensor)))
      result = sparselib.COO.from_numpy(tensor)
      return result
    elif isinstance(tensor, sparselib.COO):
      return tensor
    raise TypeError("Expected a `np.array` or `sparse.COO`. Got {}".format(type(tensor)))

  def outer_product(self, tensor1: Tensor, tensor2: Tensor) -> Tensor:
    return sparselib.outer(tensor1, tensor2)

  def einsum(self,
             expression: str,
             *tensors: Tensor,
             optimize: bool = True) -> Tensor:
    return sparselib.einsum(expression, *tensors, optimize=optimize)

  def norm(self, tensor: Tensor) -> Tensor:
    return np.linalg.norm(tensor.todense())
  ...
  def eye(self,
    ...
    return sparselib.eye(N, M=M, dtype=dtype)

  def ones(self,
           shape: Tuple[int, ...],
           dtype: Optional[np.dtype] = None) -> Tensor:
    dtype = dtype if dtype is not None else np.float64
    return sparselib.ones(shape, dtype=dtype)

  def zeros(self,
            shape: Tuple[int, ...],
            dtype: Optional[np.dtype] = None) -> Tensor:
    dtype = dtype if dtype is not None else np.float64
    return sparselib.zeros(shape, dtype=dtype)
  ...
  def randn(self,
    ...
    return sparselib.COO.from_numpy(data)
  ...
  def random_uniform(self,
    ...
    data = np.random.uniform(boundaries[0], boundaries[1], shape).astype(dtype)
    return sparselib.COO.from_numpy(data)

  def conj(self, tensor: Tensor) -> Tensor:
    return sparselib.COO.from_numpy(np.conj(tensor))

  def eigh(self, matrix: Tensor) -> Tuple[Tensor, Tensor]:
    eigvals, eigvecs = np.linalg.eigh(matrix)
    return sparselib.COO.from_numpy(eigvals), sparselib.COO.from_numpy(eigvecs)
  ...
  def eigsh_lanczos(self,
    ...
    return sparselib.COO.from_numpy(eigvals[0:numeig]), sparselib.COO.from_numpy(eigenvectors)
  ...
  def divide(self, tensor1: Tensor, tensor2: Tensor) -> Tensor:
    return sparselib.COO.from_numpy(tensor1.todense() / tensor2.todense())
  ...
  def inv(self, matrix: Tensor) -> Tensor:
    ...
    return sparselib.COO.from_numpy(np.linalg.inv(matrix.todense()))
  ...
  def sin(self, tensor: Tensor) -> Tensor:
    return sparselib.sin(tensor)

  def cos(self, tensor: Tensor) -> Tensor:
    return sparselib.cos(tensor)

  def exp(self, tensor: Tensor) -> Tensor:
    return sparselib.exp(tensor)

  def log(self, tensor: Tensor) -> Tensor:
    return sparselib.log(tensor)
  ...
  def sum(self,
    ...
    return sparselib.sum(tensor, axis=tuple(axis), keepdims=keepdims)

  def matmul(self, tensor1: Tensor, tensor2: Tensor) -> Tensor:
    if (tensor1.ndim <= 1) or (tensor2.ndim <= 1):
      raise ValueError("inputs to `matmul` have to be a tensors of order > 1,")
    return sparselib.dot(tensor1, tensor2)
  ...
  def qr(self,
    ...
    return decompositions.qr(np, tensor.todense(), pivot_axis, non_negative_diagonal)
  ...
  def rq(self,
         ...
         non_negative_diagonal: bool = False) -> Tuple[Tensor, Tensor]:
    #pylint: disable=too-many-function-args
    return decompositions.rq(np, tensor.todense(), pivot_axis, non_negative_diagonal)
  ...
  def diagonal(self,
    ...
    """
    return sparselib.COO.from_numpy(np.diagonal(tensor.todense(), offset=offset, axis1=axis1, axis2=axis2))
  ...
  def diagflat(self, tensor: Tensor, k: int = 0) -> Tensor:
    ...
    """
    return sparselib.COO.from_numpy(np.diagflat(tensor.todense(), k=k))
  ...
  def trace(self,
    ...
    """
    return sparselib.trace(tensor, offset=offset, axis1=axis1, axis2=axis2)
  ...
  def serialize_tensor(self, tensor: Tensor) -> str:
    ...
    """
    m = io.BytesIO()
    np.save(m, tensor.todense(), allow_pickle=False)
    m.seek(0)
  ...
  def deserialize_tensor(self, s: str) -> Tensor:
    ...
    m.seek(0)
    return sparselib.COO.from_numpy(np.load(m))
  ...
  def power(self, a: Tensor, b: Union[Tensor, float]) -> Tensor:
    ...
    """
    return sparselib.COO.from_numpy(np.power(a.todense(), b))
